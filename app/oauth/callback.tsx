...
export default function OAuthCallback() {
  ...
  return (
    <SafeAreaView className="flex-1" edges={["top", "bottom", "left", "right"]}>
      <ThemedView className="flex-1 items-center justify-center gap-4 p-5 bg-background dark:bg-primary">
        {status === "processing" && (
          <>
            <ActivityIndicator size="large" color="#4A1560" />
            <Text className="mt-4 text-base leading-8 text-center text-foreground" style={{ minHeight: 56 }}>
        ...
        {status === "success" && (
          <>
            <Text className="text-base leading-8 text-center text-foreground" style={{ minHeight: 56 }}>
